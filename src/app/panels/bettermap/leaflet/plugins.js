...
!function(t, e) {
    L.MarkerClusterGroup = L.FeatureGroup.extend({
        ...
        removeLayer: function(t) {
            return this._map ? t.__parent ? (this._unspiderfy && (this._unspiderfy(),
            this._unspiderfyLayer(t)),
            this._removeLayer(t, !0),
            (t._icon || t._container) && (L.FeatureGroup.prototype.removeLayer.call(this, t),
        ...
        addLayers: function(t) {
            var e, i, n;
            if (!this._map)
                return this._needsClustering = this._needsClustering.concat(t),
                this;
            for (e = 0,
            i = t.length; i > e; e++)
                if (n = t[e],
                !this.hasLayer(n) && (this._addLayer(n, this._maxZoom),
        ...
        removeLayers: function(t) {
            ...
            i = t.length; i > e; e++)
                ...
                n._icon && (L.FeatureGroup.prototype.removeLayer.call(this, n),
                n.setOpacity(1)));
        ...
        clearLayers: function() {
            this._map || (this._needsClustering = [],
        ...
        zoomToShowLayer: function(t, e) {
            ...
            ;
            t._icon ? e() : t.__parent._zoom < this._map.getZoom() ? (this._map.on("moveend", i, this),
            t._icon || this._map.panTo(t.getLatLng())) : (this._map.on("moveend", i, this),
        ...
        onAdd: function(t) {
            this._map = t;
            var e, i, n;
            for (this._gridClusters || this._generateInitialClusters(),
            e = 0,
            ...
            e = 0,
            i = this._needsClustering.length; i > e; e++)
        ...
        _removeLayer: function(t, e, i) {
            ...
            if (e)
                for (var o = this._maxZoom; o >= 0 && r[o].removeObject(t, s.project(t.getLatLng(), o)); o--)
                    ;
            var a, l = t.__parent, _ = l._markers;
            for (this._arraySplice(_, t); l && (l._childCount--,
            !(l._zoom < 0)); )
                e && l._childCount <= 1 ? (a = l._markers[0] === t ? l._markers[1] : l._markers[0],
                ...
                l._icon && (L.FeatureGroup.prototype.removeLayer.call(this, l),
                i || (a._noHas = !0,
                L.FeatureGroup.prototype.addLayer.call(this, a),
                delete a._noHas))) : (l._recalculateBounds(),
        ...
        _bindEvents: function() {
            ...
            , this),
            n && (this.on("clustermouseover", function(i) {
                this._inZoomAnimation || (t && e.removeLayer(t),
                i.layer.getChildCount() > 2 && i.layer !== this._spiderfied && (t = new L.Polygon(i.layer.getConvexHull(),this.options.polygonOptions),
                e.addLayer(t)))
            }
            , this),
            ...
            , this),
            e.on("layerremove", function(i) {
                t && i.layer === this && (e.removeLayer(t),
                t = null )
            }
            , this))
        },
        _unbindEvents: function() {
            ...
            e && (this.off("clustermouseover", null , this),
        ...
        _moveEnd: function() {
            if (!this._inZoomAnimation) {
                ...
                this._topClusterLevel._recursivelyAddChildrenToMap(null , this._zoom, t),
        ...
        _addLayer: function(t, e) {
            var i, n, r = this._gridClusters, s = this._gridUnclustered;
            for (this.options.singleMarkerMode && (t.options.icon = this.options.iconCreateFunction({
                ...
                if (o = s[e].getNearObject(i)) {
                    ...
                    for (a._addChild(_),
                    n = e; n >= 0 && s[n].removeObject(o, this._map.project(o.getLatLng(), n)); n--)
                        ;
                    return
                }
                s[e].addObject(t, i)
        ...
        _mergeSplitClusters: function() {
            this._zoom < this._map._zoom ? (this._animationStart(),
    ...
    L.MarkerClusterGroup.include(L.DomUtil.TRANSITION ? {
        ...
        _animationZoomIn: function(t, e) {
            var i, n = this, r = this._getExpandedVisibleBounds();
            this._topClusterLevel._recursively(r, t, 0, function(s) {
                var o, a = s._latlng, l = s._markers;
                for (s._isSingleParent() && t + 1 === e ? (L.FeatureGroup.prototype.removeLayer.call(n, s),
                s._recursivelyAddChildrenToMap(null , e, r)) : (s.setOpacity(0),
                s._recursivelyAddChildrenToMap(a, e, r)),
                i = l.length - 1; i >= 0; i--)
                    o = l[i],
                    r.contains(o._latlng) || L.FeatureGroup.prototype.removeLayer.call(n, o)
            }
            ),
            this._forceLayout();
            var s, o;
        ...
        _recursivelyRemoveChildrenFromMap: function(t, e, i) {
            ...
            this._recursively(t, -1, e - 1, function(t) {
                for (r = t._markers.length - 1; r >= 0; r--)
                    n = t._markers[r],
                    i && i.contains(n._latlng) || (L.FeatureGroup.prototype.removeLayer.call(t._group, n),
                    n.setOpacity && n.setOpacity(1))
            }
            , function(t) {
                for (r = t._childClusters.length - 1; r >= 0; r--)
                    n = t._childClusters[r],
                    i && i.contains(n._latlng) || ((!L.FeatureGroup.prototype.hasLayer || L.FeatureGroup.prototype.hasLayer.call(t._group, n)) && L.FeatureGroup.prototype.removeLayer.call(t._group, n),
                    n.setOpacity && n.setOpacity(1))
            }
            )
        },
        _recursively: function(t, e, i, n, r) {
            var s, o, a = this._childClusters, l = this._zoom;
            if (e > l)
                for (s = a.length - 1; s >= 0; s--)
                    o = a[s],
                    t.intersects(o._bounds) && o._recursively(t, e, i, n, r);
            else if (n && n(this),
            r && this._zoom === i && r(this),
            i > l)
                for (s = a.length - 1; s >= 0; s--)
                    o = a[s],
                    t.intersects(o._bounds) && o._recursively(t, e, i, n, r)
    ...
    L.DistanceGrid.prototype = {
        ...
        removeObject: function(t, e) {
            var i, n, r = this._getCoord(e.x), s = this._getCoord(e.y), o = this._grid, a = o[s] = o[s] || {}, l = a[r] = a[r] || [];
        ...
        getNearObject: function(t) {
            var e, i, n, r, s, o, a, l, _ = this._getCoord(t.x), h = this._getCoord(t.y), u = this._objectPoint, d = this._sqCellSize, p = null ;
            for (e = h - 1; h + 1 >= e; e++)
                if (r = this._grid[e])
                    for (i = _ - 1; _ + 1 >= i; i++)
                        if (s = r[i])
    ...
    function() {
        L.QuickHull = {
            ...
            buildConvexHull: function(t, e) {
                ...
                i = i.concat(this.buildConvexHull([n.maxPoint, t[1]], n.newPoints))) : [t]
            },
            getConvexHull: function(t) {
                var e, i = !1, n = !1, r = null , s = null ;
    ...
    L.MarkerCluster.include({
        getConvexHull: function() {
            var t, e, i, n = this.getAllChildMarkers(), r = [], s = [];
            for (i = n.length - 1; i >= 0; i--)
                e = n[i].getLatLng(),
                r.push(e);
            for (t = L.QuickHull.getConvexHull(r),
            i = t.length - 1; i >= 0; i--)
                s.push(t[i][0]);
            return s
        }
    ...
    L.MarkerCluster.include({
        ...
        spiderfy: function() {
            if (this._group._spiderfied !== this && !this._group._inZoomAnimation) {
                var t, e = this.getAllChildMarkers(), i = this._group, n = i._map, r = n.latLngToLayerPoint(this._latlng);
                this._group._unspiderfy(),
                this._group._spiderfied = this,
                e.length >= this._circleSpiralSwitchover ? t = this._generatePointsSpiral(e.length, r) : (r.y += 10,
        ...
        _generatePointsCircle: function(t, e) {
            var i, n, r = this._group.options.spiderfyDistanceMultiplier * this._circleFootSeparation * (2 + t), s = r / this._2PI, o = this._2PI / t, a = [];
            for (a.length = t,
            i = t - 1; i >= 0; i--)
                n = this._circleStartAngle + i * o,
                a[i] = new L.Point(e.x + s * Math.cos(n),e.y + s * Math.sin(n))._round();
            return a
        },
        _generatePointsSpiral: function(t, e) {
            var i, n = this._group.options.spiderfyDistanceMultiplier * this._spiralLengthStart, r = this._group.options.spiderfyDistanceMultiplier * this._spiralFootSeparation, s = this._group.options.spiderfyDistanceMultiplier * this._spiralLengthFactor, o = 0, a = [];
            for (a.length = t,
            i = t - 1; i >= 0; i--)
                o += r / n + 5e-4 * i,
        ...
        _noanimationUnspiderfy: function() {
            var t, e, i = this._group, n = i._map, r = this.getAllChildMarkers();
    ...
    L.MarkerCluster.include(L.DomUtil.TRANSITION ? {
        ...
        _animationSpiderfy: function(t, i) {
            var n, r, s, o, a = this, l = this._group, _ = l._map, h = _.latLngToLayerPoint(this._latlng);
            for (n = t.length - 1; n >= 0; n--)
                r = t[n],
                r.setZIndexOffset(1e6),
                r.setOpacity(0),
                r._noHas = !0,
                L.FeatureGroup.prototype.addLayer.call(l, r),
                delete r._noHas,
                r._setPos(h);
            l._forceLayout(),
            l._animationStart();
            var u = L.Path.SVG ? 0 : .3
              , d = L.Path.SVG_NS;
            for (n = t.length - 1; n >= 0; n--)
                ...
                L.Path.SVG && this.SVG_ANIMATION) {
                    var p = s._path.getTotalLength();
                    s._path.setAttribute("stroke-dasharray", p + "," + p);
                    var c = e.createElementNS(d, "animate");
                    c.setAttribute("attributeName", "stroke-dashoffset"),
                    c.setAttribute("begin", "indefinite"),
                    c.setAttribute("from", p),
                    c.setAttribute("to", 0),
                    c.setAttribute("dur", .25),
                    s._path.appendChild(c),
                    c.beginElement(),
                    c = e.createElementNS(d, "animate"),
                    c.setAttribute("attributeName", "stroke-opacity"),
                    c.setAttribute("attributeName", "stroke-opacity"),
                    c.setAttribute("begin", "indefinite"),
            ...
            L.Path.SVG)
                ...
                n = t.length - 1; n >= 0; n--)
                    r = t[n]._spiderLeg,
                    r.options.opacity = .5,
                    r._path.setAttribute("stroke-opacity", .5);
            setTimeout(function() {
                l._animationEnd(),
                l.fire("spiderfied")
            }
        ...
        _animationUnspiderfy: function(t) {
            var e, i, n, r = this._group, s = r._map, o = t ? s._latLngToNewLayerPoint(this._latlng, t.zoom, t.center) : s.latLngToLayerPoint(this._latlng), a = this.getAllChildMarkers(), l = L.Path.SVG && this.SVG_ANIMATION;
            for (r._animationStart(),
            this.setOpacity(1),
            i = a.length - 1; i >= 0; i--)
                e = a[i],
                ...
                e._setPos(o),
                e.setOpacity(0),
                l && (n = e._spiderLeg._path.childNodes[0],
        ...
        _animationSpiderfy: function(t, e) {
            var i, n, r, s, o = this._group, a = o._map;
    ...
    L.MarkerClusterGroup.include({
        ...
        _spiderfierOnAdd: function() {
            ...
            this._map.options.zoomAnimation ? this._map.on("zoomstart", this._unspiderfyZoomStart, this) : this._map.on("zoomend", this._unspiderfyWrapper, this),
        ...
        _unspiderfyLayer: function(t) {
            t._spiderLeg && (L.FeatureGroup.prototype.removeLayer.call(this, t),
            t.setOpacity(1),
            t.setZIndexOffset(0),
...
(function() {
    ...
    L.Label = L.Popup.extend({
        ...
        onAdd: function(t) {
            ...
            e && L.DomUtil.setOpacity(this._container, 0),
        ...
        onRemove: function(t) {
            ...
            t.options.fadeAnimation && L.DomUtil.setOpacity(this._container, 0),
            this._map = null 
        },
        close: function() {
            var t = this._map;
        ...
        _setPosition: function(t) {
            t = t.add(this.options.offset),
            L.DomUtil.setPosition(this._container, t)
        },
    ...
    L.Marker.include({
        showLabel: function() {
            return this._label && this._map && (this._label.setLatLng(this._latlng),
            this._map.showLabel(this._label)),
            this
        },
        hideLabel: function() {
            return this._label && this._label.close(),
            this
        },
        setLabelNoHide: function(t) {
            this._labelNoHide !== t && (this._labelNoHide = t,
            t ? (this._removeLabelRevealHandlers(),
        ...
        bindLabel: function(t, e) {
            ...
            return i = i.add(L.Label.prototype.options.offset),
            e && e.offset && (i = i.add(e.offset)),
            e = L.Util.extend({
                offset: i
            }, e),
            this._labelNoHide = e.noHide,
            this._label || (this._labelNoHide || this._addLabelRevealHandlers(),
            this.on("remove", this.hideLabel, this).on("move", this._moveLabel, this),
            this._hasLabelHandlers = !0),
            this._label = new L.Label(e,this).setContent(t),
            this
        },
        unbindLabel: function() {
            return this._label && (this.hideLabel(),
            this._label = null ,
            this._hasLabelHandlers && (this._labelNoHide || this._removeLabelRevealHandlers(),
            this.off("remove", this.hideLabel, this).off("move", this._moveLabel, this)),
        ...
        _removeLabelRevealHandlers: function() {
            this.off("mouseover", this.showLabel, this).off("mouseout", this.hideLabel, this).off("remove", this.hideLabel, this).off("move", this._moveLabel, this),
        ...
        _updateZIndex: function(t) {
            ...
            this._label && this._label.updateZIndex(e)
        },
        ...
        _updateOpacity: function() {
            ...
            this._label && this._label.setOpacity(this.options.labelHasSemiTransparency ? this.options.opacity : t)
        }
    }),
    L.Path.include({
        bindLabel: function(t, e) {
            return this._label && this._label.options === e || (this._label = new L.Label(e,this)),
            this._label.setContent(t),
        ...
        unbindLabel: function() {
            return this._label && (this._hideLabel(),
            this._label = null ,
